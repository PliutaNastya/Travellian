        ...
        if (document.querySelector("[data-datepicker]")) {
            const picker = datepicker_min("[data-datepicker]", {
                ...
                formatter: (input, date, instance) => {
                    ...
                    const value = `${days[n]}, ${numb} ${months[month]} ${year}`;
                    input.value = value;
                }
            });
        ...
        function initSliders() {
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                pagination: {
                    ...
                    type: "bullets",
                    clickable: true,
                    bulletClass: "main-block__bullet",
                    bulletActiveClass: "main-block__bullet_active"
                },
                navigation: {
            ...
            if (document.querySelector(".popular__body")) new core(".popular__slider", {
            ...
            if (document.querySelector(".special-offer__body")) new core(".special-offer__slider", {
                modules: [ Navigation, Autoplay ],
                speed: 800,
                effect: "fade",
                fadeEffect: {
            ...
            if (document.querySelector(".planners__body")) new core(".planners__slider", {
            ...
            if (document.querySelector(".gallery__body")) new core(".gallery__slider", {
                modules: [ Navigation, Autoplay ],
                speed: 800,
                effect: "fade",
                fadeEffect: {
            ...
            if (document.querySelector(".reviews__body")) new core(".reviews__slider", {
                modules: [ Navigation, Autoplay ],
                speed: 800,
                effect: "fade",
                fadeEffect: {
